...
def xoshnaw():
  ...
  id = "-".join(uuid)
  server = requests.get('https://github.com/ICE-H4CKER/Old/blob/main/Approval.txt').text
...
def banner():
	...
	sol().print(wel2)
	au='AUTHOR    :  TONYE\nGITHUB    :  https://github.com/DG-SM4RT\nWHATSAPP  :  +2349075815126'
